...
public class TestCase_mobileProductPageValidation extends TestBase {
	...
	public void TC01() throws InterruptedException {
		...
		/*
		 * rp.inputPhoneNumber("9552565645", "k@gmail.com", "12345678", "Male",
		 * "28/07/1997"); rp.clickSubmit();
		 * 
		 * rp.acceptAlert();
		 */
	...
	public Object[][] getMobileData() throws Exception {
		return TestDataUtils.getUtilsClass("TestData/testdata.xlsx", "Mobile");
	}
